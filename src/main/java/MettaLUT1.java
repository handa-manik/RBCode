...
public class MettaLUT1 extends AdvancedRobot //Robot
{
    // Learning constants
    ...
    // Learning parameters
    private static final double ALPHA = 0.1;    // Fraction of difference used
    ...
    private static final String QDIFF_FILE_NAME = "./ass2QDiff.dat";
    private File mLutFile;
    private File qDiffFile;
    ...
    double QDiffAction = 0.0;
    int round=0; //not carried between rounds

    public void run()
    {

        System.out.println("Is this running after round?" + round);
    ...
    private void learn(boolean terminalState) throws IOException {
        double qPrevNew;
        int currentStateHash, actionHash;

        printDebug("==[LEARN]=========================================\n");
        System.out.println("The Terminal state : " + terminalState);
        ...
        switch (mCurrentLearningPolicy)
        {
            ...
            case SARSA:
                ...
                if (terminalState)
                {
                    ...
                    System.out.println("The QDiff is : " + qDiff);
                    System.out.println("The qRime is : " + qTime);
                    QDiffAction = qDiff/qTime;

                    System.out.println("QDiff for this round : " + round +" is "+ QDiffAction);

                    //Writing file
                    qDiffFile = getDataFile(QDIFF_FILE_NAME);
                    FileInputStream fileOut2 = new FileInputStream(qDiffFile);
                    BufferedReader bis = new BufferedReader(new FileReader(qDiffFile));
                    ...
                    bis.close();
                    System.out.println("Previous value is : " + gp);

                    BufferedOutputStream bp = new BufferedOutputStream(new RobocodeFileOutputStream(qDiffFile));
                    String lp = gp + String.valueOf(QDiffAction) + ";";
                    System.out.println("Writing the value : " + lp);
                    bp.write(lp.getBytes());
                    bp.flush();
                    bp.close();
                    fileOut2.close();
    ...
    private double calculateQPrevNew(double qNext)
    {
        ...
        qLDiff = qPrevNew - qPrevOld;
        System.out.println("The QDIff is : " + qLDiff);
        qDiff += Math.abs(qLDiff);
        qTime++;
        System.out.println("The Qtime is : " + qTime);
        return qPrevNew;
    }
    ...
    public void onBattleEnded(BattleEndedEvent event)
    {
        ...
        System.out.println("On Batter End");
        saveLut(mLutFile);
